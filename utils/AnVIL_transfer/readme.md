...
There is a fail log in SUMMARY_last_batches_including_DC, but I'm 99% sure it's because when running Kinnex part 4 I forgot to remove the header line of the input file (https://github.com/human-pangenomics/HPRC_metadata/blob/b4925166b9d888db89b4c439e6ce526fcab17df5/utils/AnVIL_transfer/input_tsvs/KINNEX_data_to_input%20(attempt%204).tsv#L1).

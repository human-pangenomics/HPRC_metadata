...
```
WARNING: Found 1107 files not referenced in any member of index_sheets -- these files may represent renames, files for future releases, etc...
...
│ {["manifest", "HPRC_PLUS_nanopore_misc_R2_data_table__final.csv"],6}      │
│ {["HPRC_PLUS_nanopore_misc_R2_data_table__final.csv", "manifest"],3}      │
...
│ {["RU_Y3_topoff_redo_data_table__final.csv"],1}                           │
└───────────────────────────────────────────────────────────────────────────┘
